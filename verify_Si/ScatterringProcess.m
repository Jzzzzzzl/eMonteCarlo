        ...
        function [es,ps] = ElectricScatProcess(es, ps, bs, sc, pc, sr)
            ...
            switch sr.scatType
                ...
                case 6 % inter_g_ab_LO
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'g', 'ab', 'LO');
                case 7 % inter_f_ab_TA
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'f', 'ab', 'TA');
                case 8 % inter_f_ab_LA
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'f', 'ab', 'LA');
                case 9 % inter_f_ab_TO
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'f', 'ab', 'TO');
                case 10 % inter_g_em_TA
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'g', 'em', 'TA');
                case 11 % inter_g_em_LA
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'g', 'em', 'LA');
                case 12 % inter_g_em_LO
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'g', 'em', 'LO');
                case 13 % inter_f_em_TA
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'f', 'em', 'TA');
                case 14 % inter_f_em_LA
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'f', 'em', 'LA');
                case 15 % inter_f_em_TO
                    [es, ps] = ChooseFinalVectorOfInterScat(es, ps, sc, pc, 'f', 'em', 'TO');
                case 16 % 
                    return;
            end
        end
