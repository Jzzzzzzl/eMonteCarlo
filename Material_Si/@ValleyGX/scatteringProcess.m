function [es, ps] = scatteringProcess(obj, dv, es, ps, sc, pc)
    ...
    switch es.scatype
        ...
        case 2 % intra_ab_LA
            ps.aborem = "ab";
            ps.polar = "LA";
            k = obj.chooseStandardVectorForInelasticScattering(es, pc, 'intra', polyval(sc.band.LA, obj.qAB), 1);
            es = obj.getGeneralElectricWaveVector(es, pc, k);
        case 3 % intra_ab_TA
            ps.aborem = "ab";
            ps.polar = "TA";
            k = obj.chooseStandardVectorForInelasticScattering(es, pc, 'intra', polyval(sc.band.TA, obj.qAB), 1);
            es = obj.getGeneralElectricWaveVector(es, pc, k);
        case 4 % intra_em_LA
            ps.aborem = "em";
            ps.polar = "LA";
            ...
            k = obj.chooseStandardVectorForInelasticScattering(es, pc, 'intra', polyval(sc.band.LA, obj.qEM), -1);
            es = obj.getGeneralElectricWaveVector(es, pc, k);
        case 5 % intra_em_TA
            ps.aborem = "em";
            ps.polar = "TA";
            ...
            k = obj.chooseStandardVectorForInelasticScattering(es, pc, 'intra', polyval(sc.band.TA, obj.qEM), -1);
            es = obj.getGeneralElectricWaveVector(es, pc, k);
        case 6 % inter_g_ab_LA
            ...
            k = dv.valley.chooseStandardVectorForInelasticScattering(es, pc, 'inter', sc.wg.LA, 1);
        ...
        case 7 % inter_g_ab_TA
            ...
            es.valley = randomValley(es, "interg");
            dv.valleyGuidingPrinciple(es);
            k = dv.valley.chooseStandardVectorForInelasticScattering(es, pc, 'inter', sc.wg.TA, 1);
            es = dv.valley.getGeneralElectricWaveVector(es, pc, k);
        case 8 % inter_g_ab_LO
            ...
            es.valley = randomValley(es, "interg");
            dv.valleyGuidingPrinciple(es);
            k = dv.valley.chooseStandardVectorForInelasticScattering(es, pc, 'inter', sc.wg.LO, 1);
            es = dv.valley.getGeneralElectricWaveVector(es, pc, k);
        case 9 % inter_f_ab_LA
            ...
            dv.valleyGuidingPrinciple(es);
            k = dv.valley.chooseStandardVectorForInelasticScattering(es, pc, 'inter', sc.wf.LA, 1);
            es = dv.valley.getGeneralElectricWaveVector(es, pc, k);
        case 10 % inter_f_ab_TA
            ...
            es.valley = randomValley(es, "interf");
            dv.valleyGuidingPrinciple(es);
            k = dv.valley.chooseStandardVectorForInelasticScattering(es, pc, 'inter', sc.wf.TA, 1);
            es = dv.valley.getGeneralElectricWaveVector(es, pc, k);
        case 11 % inter_f_ab_TO
            ...
            es.valley = randomValley(es, "interf");
            dv.valleyGuidingPrinciple(es);
            k = dv.valley.chooseStandardVectorForInelasticScattering(es, pc, 'inter', sc.wf.TO, 1);
            es = dv.valley.getGeneralElectricWaveVector(es, pc, k);
