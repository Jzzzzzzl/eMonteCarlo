classdef ScatterringRateTableGamma3 < ScatterringRateTableForValley
    ...
    methods
        ...
        function scatterringTable(obj, dv, es, sc, pc, cc)
            ...
            obj.scatTable(6)  = obj.inelasticInterAB(pc.G32UDK, 1, sc.wU2GLA, (pc.EgU - pc.EgG3));
            obj.scatTable(7)  = obj.inelasticInterAB(pc.G32UDK, 1, sc.wU2GLO, (pc.EgU - pc.EgG3));
            obj.scatTable(8)  = obj.inelasticInterEM(pc.G32UDK, 1, sc.wU2GLA, (pc.EgU - pc.EgG3));
            obj.scatTable(9)  = obj.inelasticInterEM(pc.G32UDK, 1, sc.wU2GLO, (pc.EgU - pc.EgG3));
