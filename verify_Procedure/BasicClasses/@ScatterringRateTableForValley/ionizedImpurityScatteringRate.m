function ionizedImpurityScatteringRate(obj, dv, es, pc, cc)
    %>生成电离杂质散射句柄函数(弹性)
    %>     参数说明：
    %>     n：某位置掺杂浓度
    % ======================================================================
    ...
    obj.ionizedImpurity = sqrt(2)*pc.e^4*n*dv.bs.md^(3/2) ...
                                ...
                                * real(sqrt(es.gamma))*(1 + 2*es.epsilon/pc.e*dv.bs.alpha) ...
                                / (qD^2*(qD^2 + 8*dv.bs.md*es.gamma/pc.hbar^2))*obj.xsForimpurity;
