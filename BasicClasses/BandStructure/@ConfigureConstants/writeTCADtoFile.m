function writeTCADtoFile(obj)
    ...
    if obj.NY == 1
        ...
        writeDataToFile1D('heatConduc', obj, X, obj.heatConduc.data(2:end-1, obj.NY+1));
        writeDataToFile1D('latticeTem', obj, X, obj.latticeTem.data(2:end-1, obj.NY+1));
        writeDataToFile1D('jouleHeat', obj, X, obj.jouleHeat.data(2:end-1, obj.NY+1));
        writeDataToFile1D('conducBand', obj, X, obj.conducBand.data(2:end-1, obj.NY+1));
        writeDataToFile1D('eMobility', obj, X, obj.eMobility.data(2:end-1, obj.NY+1));
        writeDataToFile1D('dopDensity', obj, X, obj.dopDensity.data(2:end-1, obj.NY+1));
        writeDataToFile1D('eleConc', obj, X, obj.eleConc.data(2:end-1, obj.NY+1));
        writeDataToFile1D('xField', obj, X, obj.xField.data(2:end-1, obj.NY+1));
        writeDataToFile1D('yField', obj, X, obj.yField.data(2:end-1, obj.NY+1));
        writeDataToFile1D('xyField', obj, X, obj.xyField.data(2:end-1, obj.NY+1));
    else
        ...
        writeDataToFile2D('heatConduc', obj, X, Y, obj.heatConduc.data(2:end-1, 2:end-1));
