function energyHistoryDistribution(obj, sh, cc, e, N)
    %>电子能量分布
    ...
    cc.energyGrid(0, e, N);
    enumber = zeros(cc.NE, 2);
    for i = 1 : cc.NE
        index = energys >= cc.energy.face(i) & energys < cc.energy.face(i + 1);
        enumber(i, 1) = cc.energy.point(i + 1);
